import {
  ...
  generateText,
  tool
} from "../../../../chunk-U636JLIE.mjs";
import "../../../../chunk-LPT2FHID.mjs";
import {
  external_exports,
  task
...
async function fetchPolyfill() {
  return typeof globalThis.fetch !== "undefined" ? globalThis.fetch : (await import("../../../../lib-G22S5DKT.mjs")).default;
}
