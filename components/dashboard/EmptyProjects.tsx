  ...
  return (
    <div className="flex flex-col items-center justify-center py-20 text-center">
      ...
      <div className="relative mb-6">
        ...
        <div className="relative w-20 h-20 rounded-2xl bg-card/80 backdrop-blur-md border border-border/40 flex items-center justify-center shadow-2xl">
